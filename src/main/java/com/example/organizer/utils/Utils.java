...
//                        || (searchTime >= 0
//                                && searchTime >= show.getStartTime()
//                                && searchTime <= show.getStartTime() + show.getDuration())
//                        || (searchTime >= 0 && show.getStartTime() + show.getDuration() > 24*60
//                            && (searchTime <= (show.getStartTime() + show.getDuration()) % 24*60
//                                || searchTime >= show.getStartTime()))
